...
class FoldersClient(metaclass=FoldersClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = FoldersClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = FoldersClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = FoldersClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = FoldersClient._read_environment_variables()
        self._client_cert_source = FoldersClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = FoldersClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, FoldersTransport)
        if transport_provided:
            ...
            self._transport = cast(FoldersTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or FoldersClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[FoldersTransport], Callable[..., FoldersTransport]
            ] = (
                FoldersClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., FoldersTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.resourcemanager_v3.FoldersClient`.",
                    extra={
