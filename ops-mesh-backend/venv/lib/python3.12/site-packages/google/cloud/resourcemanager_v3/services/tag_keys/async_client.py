...
class TagKeysAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = TagKeysClient._DEFAULT_ENDPOINT_TEMPLATE
    ...
    get_transport_class = TagKeysClient.get_transport_class
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.resourcemanager_v3.TagKeysAsyncClient`.",
                extra={
    ...
    async def __aenter__(self) -> "TagKeysAsyncClient":
        return self
