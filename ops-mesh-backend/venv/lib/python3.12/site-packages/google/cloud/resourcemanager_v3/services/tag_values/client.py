...
class TagValuesClient(metaclass=TagValuesClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = TagValuesClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = TagValuesClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = TagValuesClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = TagValuesClient._read_environment_variables()
        self._client_cert_source = TagValuesClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = TagValuesClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, TagValuesTransport)
        if transport_provided:
            ...
            self._transport = cast(TagValuesTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or TagValuesClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                Type[TagValuesTransport], Callable[..., TagValuesTransport]
            ] = (
                TagValuesClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., TagValuesTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.resourcemanager_v3.TagValuesClient`.",
                    extra={
